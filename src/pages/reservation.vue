        ...
        <q-dialog v-model="login">
          <q-card>
            ...
            <q-card-section class="q-pt-none text-center">
              <q-input v-model="clientEmailLogin" type="email" label="Enter Email Address" style="width:420px;" class="q-pa-sm q-px-md" outlined="" color="orange-7" dense/>
              <q-input v-model="clientPasswordLogin" type="password" label="Enter Password" style="width:420px;" class="q-pa-sm q-px-md" outlined="" color="orange-7" dense/>
